 ...
 * @author Lenovo
 */
@Named("showFormEmployeePageBean")
@RequestScoped
public class ShowFormEmployeePageBean {
    ...
    @PostConstruct
    public void init(){
        allForms = formSession.findEmployeeForms();
   ...
   public void onRowSelect(SelectEvent event) throws IOException {
       ...
       FacesContext.getCurrentInstance().getExternalContext().redirect("editForm.xhtml?id=" +formToEdit.getId());
    }
